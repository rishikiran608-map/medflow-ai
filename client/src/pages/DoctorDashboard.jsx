                      ...
                      {!isUser && msg.citations && msg.citations.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-0.5 max-w-[85%]">
                          {msg.citations.map((cite, cIdx) => (
                            <div
                              key={cIdx}
                              className="inline-flex items-center gap-1 bg-teal-50/50 text-teal-600 border border-teal-100 rounded-full px-2 py-0.5 text-[9px] font-black tracking-wide"
                            >
                              <span>📖</span>
